...
int main(int argc, char **argv) {	
	// Defining basic matrix and vectors
	...
	// Type casting to wrong direction and giving error
	...
	// calculate eigen vectos and eigen values
	...
	// comparing direct inversion vs QR decomposition
	// QR decomposition is much faster than direct inversion
